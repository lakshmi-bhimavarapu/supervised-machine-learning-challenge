...
In this assignment, I created machine learning models to classify the risk level of given loans. Specifically, by comparing the Logistic Regression model and Random Forest Classifier.
